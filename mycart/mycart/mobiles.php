...
<div id="products-wrapper">
	...
	$results = mysql_query("SELECT * FROM products where ptype='mobile' ORDER BY id ASC");
    if ($results) { 
        ...
        while($obj = mysql_fetch_array($results))
        {
			...
			echo '<div class="product-thumb"><img height="100" width="100" src="images/mobiles/'.$obj['product_img_name'].'"></div>';
