...
<body>
	...
	<div class="blog">
		<div class="container">
			<div class="col-md-8 blog-left" >
				<div class="blog-info">
			      <center >
				  <h3>Update Priority</h3><br>
				  <br><form action="school.php" method="post">
				  Enter Priority <input type="text" name="Prio_name"><br>
				  <br>
				  
				  Priority Order <input type="text" name="Prio_or"><br>
				  <br>
				...
				<!--<h3><center-left><button type="button" id="btn1">Check Previous priorities</button></center-left>&nbsp;&nbsp;&nbsp;&nbsp;<center-right><button type="button" id="btn2">Update Priorities</button></center-left></h3>-->
				<!--<ul class="menu">
					<li class="item1"><a href="#"> School 1 Link</a>
				...
				<!--<div class="blog-info">
					...
					<p>Posted By <a href="#">Admin</a> &nbsp;&nbsp; on march 5, 2015 &nbsp;&nbsp; <a href="#">Comments (10)</a></p>
					<div class="blog-info-text">
						<div class="blog-img">
				...
				<div class="blog-info">
					<h3><a href="single.html">Fringilla condimentum</a></h3>
					<p>Posted By <a href="#">Admin</a> &nbsp;&nbsp; on march 10, 2015 &nbsp;&nbsp; <a href="#">Comments (10)</a></p>
					<div class="blog-info-text">
						<div class="blog-img">
			...
			<div class="col-md-4 single-page-right">
				<div class="category blog-ctgry">
					...
					<div class="list-group">
						...
						<a href="single.html" class="list-group-item">Dapibus ac facilisis</a>
						<a href="single.html" class="list-group-item">Morbi leo risus</a>
						<a href="single.html" class="list-group-item">Porta ac consectetur</a>
						<a href="single.html" class="list-group-item">Vestibulum at eros</a>
						<a href="single.html" class="list-group-item">Cras justo odio</a>
						<a href="single.html" class="list-group-item">Randomised words </a>
						<a href="single.html" class="list-group-item">Look even slightly</a>
					</div>
				</div>	-->
	...
	<!--<div class="footer">
		<div class="container">
			<p align="center ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Copyright © 2015 ISLI. All rights reserved</a></p>
		</div>
	</div>-->
