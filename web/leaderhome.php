...
<form action="submit.php" method="post">
							...
							<? php $myquery = sprintf("insert into comments (priorityid,username,comment) values (14,"Leader1","tree")");
			...
			<div class="col-md-4 single-page-right">
				<div class="category blog-ctgry">
					...
					<div class="list-group">
						<a href="feedback.php" class="list-group-item">workshop feedback</a>
						<a href="single.html" class="list-group-item">school details</a>
						<a href="single.html" class="list-group-item">attended workshop</a>
