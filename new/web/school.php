	...
	<div class="blog">
		<div class="container">
			<div class="col-md-8 blog-left" >
				...
				<h3><center-left><button type="button" id="btn1">Check Previous priorities</button></center-left>&nbsp;&nbsp;&nbsp;&nbsp;<center-right><a href="up_prior.php"><button type="button" id="btn2">Update Priorities</button></a><</center-left></h3>
				<!--<ul class="menu">
