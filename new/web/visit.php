	...
	<div class="blog">
		<div class="container">
			<div class="col-md-8 blog-left" >
				<div class="blog-info">
			<h3><center>Visit Feedback</center></h3>
			<table align="center">
			<tr>
			<td>Priority</td>
			...
			<tr><td>Weakness</td>
<td>			<input type="text" name="wek"></td>
		</tr><br>
			<tr align="center">
			<center><td><button type="button" >Submit</button></td></center></tr>
				...
				<!--<h3><center-left><button type="button" id="btn1">Current priorities</button></center-left>&nbsp;&nbsp;&nbsp;&nbsp;<center-right><button type="button" id="btn2">Update Priorities</button></center-left></h3>-->
				<!--<ul class="menu">
